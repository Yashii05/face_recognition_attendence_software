...
class Student:
    def __init__(self,root):
         ...
         #third image
         img2 =Image.open(r"C:\Users\user\OneDrive\Desktop\machine learning projects\face_regonition\college_images\iStock-182059956_18390_t12.jpg")
         ...
         Left_frame.place(x=10,y=10,width=738,height=580)

         img_left =Image.open(r"C:\Users\user\OneDrive\Desktop\machine learning projects\face_regonition\college_images\AdobeStock_303989091.jpeg")
         ...
         current_course_frame.place(x=5,y=130,width=725,height=120)
         ...
         class_div_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_div,font=("times new roman",13,"bold"),state="readonly",width=18)
         ...
         Right_frame.place(x=750,y=10,width=750,height=579)
         
         img_right =Image.open(r"C:\Users\user\OneDrive\Desktop\machine learning projects\face_regonition\college_images\gettyimages-1022573162.jpg")
         ...
         self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","div","roll","name","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
         if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
              ...
              try:
                    conn= mysql.connector.connect(host="localhost",username="root",password="yashi",database="face_recognizer")
                   ...
                   #=============== fetch data=================
    def  fetch_data(self):
         conn= mysql.connector.connect(host="localhost",user="root",password="yashi",database="face_recognizer")
         my_cursor=conn.cursor()
...
#========= dekte =====================
    def delete_data(self):
         if self.var_std_id.get()=="":
              messagebox.showerror("Error","Studient id is required",parent=self.root)
         else:
              try:
